...
describe('TextEditor Isolation Tests', () => {
  it('should maintain separate content in multiple editor instances', () => {
    ...
    const { rerender } = render(
      <>
        <TextEditor key='editor1' value='Content for editor 1' onChange={onChange1} />
        <TextEditor key='editor2' value='Content for editor 2' onChange={onChange2} />
      </>
    )
  ...
  it('should not share clipboard content between editors', () => {
    ...
    render(
      <>
        <TextEditor key='editor1' value='Original content 1' onChange={onChange1} />
        <TextEditor key='editor2' value='Original content 2' onChange={onChange2} />
      </>
    )
  ...
  it('should properly update when value prop changes', () => {
    ...
    const { rerender } = render(
      <TextEditor key='test-editor' value='Initial value' onChange={onChange} />
    )

    // Update the value prop
    rerender(<TextEditor key='test-editor' value='Updated value' onChange={onChange} />)
